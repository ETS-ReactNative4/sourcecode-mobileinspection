...
export default {
	...
	2: {
		data: "http://apis.tap-agri.com/mobileinspectionqa/ins-msa-qa-auth/api/" + verAPI + "/",
		service: "http://apis.tap-agri.com/mobileinspectionqa/ins-msa-qa-auth/api/" + verAPI + "/server/service-list?v=" + verAPK
	},
	3: {
		data: "http://apis.tap-agri.com/mobileinspectiondev/ins-msa-dev-auth/api/" + verAPI + "/",
		service: "http://apis.tap-agri.com/mobileinspectiondev/ins-msa-dev-auth/api/" + verAPI + "/server/service-list?v=" + verAPK
	},
	10000: {
