        ...
        return (
            <KeyboardAvoidingView style={styles.mainContainer} behavior="padding" enabled>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                    <Text style={{ fontSize: 15, fontFamily: Fonts.demi }}>Kamu tidak bisa scan TPH?</Text>
                    <Text style={{ fontSize: 15, fontFamily: Fonts.demi, marginTop: 5 }}>Kenapa?</Text>
                    ...
                    <Text style={{ fontSize: 15, marginTop: 10, fontFamily: Fonts.demi }}>Lokasi</Text>
                    ...
                    <Text style={{ fontSize: 15, fontFamily: Fonts.demi, marginTop: 20 }}>TPH</Text>
...
const styles = {
    ...
    textLabel: { color: Colors.brand, textAlign: 'center', fontSize: 16, fontFamily: Fonts.book },
    bubbleOff: { borderWidth: 1, borderColor: '#989898', borderRadius: 20 },
    bubbleOn: { backgroundColor: Colors.brand, borderRadius: 20, },
    buttonTextOff: { fontSize: 14, color: '#808080', textAlign: 'center', fontFamily: Fonts.thin },
    buttonTextOn: { fontSize: 14, color: '#ffffff', textAlign: 'center', fontFamily: Fonts.thin }
}
